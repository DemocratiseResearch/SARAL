...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  const navigationItems = [
    ...
    { to: '/manim-animation', icon: FiActivity, label: 'Manim Animation', step: 0 },
    { to: '/whiteboard-animation', icon: FiEdit, label: 'Whiteboard Animation', step: 0 },
    { to: '/poster-generation', icon: FiImage, label: 'Poster Generation', step: 0 },
    { to: '/saras', icon: FiMessageSquare, label: 'SARAS Chat', step: 0 },
